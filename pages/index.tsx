...
const PropertyListingPage: React.FC = () => {
  ...
  const filteredProperties = properties.filter((property) => {
    ...
    if (activeFilter === "Top Villa")
      return (
        property.category.includes("Luxury Villa") ||
        property.name.includes("villa")
      );
    if (activeFilter === "Self Checkin")
      return property.category.includes("Self Checkin");
    if (activeFilter === "Free Reschedule")
      return property.category.includes("Free Reschedule");
    return true;
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-8xl  m-4 md:m-10  px-4 py-8">
        ...
        <div className="text-center mt-12">
          <button className="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-700 transition-colors duration-300 ">
            Show More
          </button>
